...
Usage :
  python simulateur_capteurs.py                        → local (localhost:5000)
  python simulateur_capteurs.py --url https://cypheralee.pythonanywhere.com
  python simulateur_capteurs.py --url https://ton-app.railway.app --interval 10
"""
